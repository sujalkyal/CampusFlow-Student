            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex justify-between items-center">
                ...
                <Link
                  ...
                  className="text-sm text-[#5f43b2] hover:text-[#5f43b2]/80 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <motion.button
                type="submit"
                className="w-full bg-[#5f43b2] text-white p-4 rounded-xl hover:bg-[#5f43b2]/90 flex items-center justify-center font-medium transition-all duration-300 mt-6 cursor-pointer"
